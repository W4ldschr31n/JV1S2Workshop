...
label chapter_1:
    ...
    narrateur "{cps=25}En France des milliers d'artisans produisent chaque jour un produit emblématique de la culture gastronomique de notre pays qui accompagne chaque repas des français, le fromage."
    narrateur "{cps=25}Chaque régions possede ses spécialités que vendent les fromagerie, et nous allons suivre aujourd'hui l'une d'entre elles."
    ...
    narrateur "{cps=25}Une vie de senteur, bien appréciée de John, fromager depuis 20 ans."
    show john at left:
        zoom 0.5
    john "{cps=25}Alors ici on est dans l'affinerie, c'est là où reposent tous nos magnifiques fromages et où ils prennent leurs goûts. C'est un métier de la patience et c'est vrai qu'il faut en être passionné."
    ...
    journaliste "{cps=25}Pour atteindre ce but, Jean s'entraine énormément en autodidacte. Après quelques négociations, il nous autorise enfin une petite session privée."
