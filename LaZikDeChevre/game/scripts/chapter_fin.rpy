label findrogue:
    ...
    narrateur "Nous apprendrons quelques temps plus tard que Jean a succombé au vice de la drogue."
...
label fin_good:
    scene black
    narrateur "Nous obtiendrons des nouvelles de Rocklette deux jours plus tard via une story Instagram. La superstar, ayant repris du poil de la bête, 
    annonça son retour sur scène avec quelques nouveautés de sa composition."
    scene bgwin
    narrateur "Par la suite, Rocklette sortit son premier album en hommage à sa vie fromagère."
    narrateur "L'album eut un succès monstrueux et la côte de Rocklette, déjà haute, grimpa en flèche. Il débuta une tournée nationale avant que son nom soit se fasse connaître dans le monde entier."
    narrateur "Une vie de succès et d'épanouissement dans le milieu auquel il aspirait, Jean est désormais un exemple pour beaucoup de jeunes souhaitant intégrer le milieu du rock. 
