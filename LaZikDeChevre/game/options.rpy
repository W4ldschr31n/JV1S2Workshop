...
define config.name = _("De_fromager_a_legende_du_rock")
...
define build.name = "De_fromager_a_legende_du_rock"
...
define config.save_directory = "LaZikDeChevre-1707139604"
